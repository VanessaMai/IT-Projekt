...
public interface RoomReservationServiceAdministration extends RemoteService {
	...
	/**
	 * Dient zur Initialisierung des Objekts. Diese Methode wird bei Aufruf des
	 * Systems automatisch ausgeführt.
	 */
	 ...
	 *            Thema der Belegung
	 * @param startDate
	 *            Anfangszeitpunkt der Raumbelegung
	 * @param endDate
	 *            Endzeitpunkt der Raumbelegung
	 * @param room
	 *            Raum in dem die Belegung stattfindet
	 * @param organizer
	 *            Nutzer der diese Raumbelegung angelegt hat
	 * @param invitees
	 *            Eine Liste der Nutzer, die zu dieser Raumbelegung eingeladen
	 *            werden
	 */
	 ...
	 * 
	 * @param Room
	 *            Raum der gespeichert werden soll
	 * @throws IllegalArgumentException
	 */
	 ...
	 * 
	 * @param user
	 *            Nutzerobjekt das gespeichert werden soll
	 * @throws IllegalArgumentException
	 */
	 ...
	 * 
	 * @param Event
	 *            Eventobjekt das gespeichert werden soll
	 * @throws IllegalArgumentException
	 */
	 ...
	 * 
	 * @param Invitation
	 *            Invitationobjekt das gespeichert werden soll
	 * @throws IllegalArgumentException
	 */
	 ...
	 * 
	 * @param name
	 *            Name eines User-Objektes (kann vor oder Nachname sein)
	 * @return Vector-Objekt mit allen Customer-Objekten, welche die
	...
	/**
	 * Ausgeben aller User-Objekte, die zu einem Event-Objekt gehören und einen
	 * bestimmten Annahmestatus in der Einladung haben
	 * 
	 * @param event
	 *            Raumbelegung zu der die User-Objekte gehören
	 * @param participationStatus
	 *            der Status der Einladung zu einer bestimmten Belegung, true
	 *            oder false
	 * @return Vector Objekten mit den User-Objekten, welche die Suchkriterien
	 *         erfüllen
	 * @throws IllegalArgumentException
	 */
	 ...
	 * 
	 * @param room
	 *            Raum-Objekt in dem die Belegungen sind
	 * @return Vector-Objekt mit den Event-Objekten, welche die Suchkriterien
	 *         erfüllen
	 * @throws IllegalArgumentException
	 */
	...
	/**
	 * Ausgeben aller Event-Objekte von dem übergebenen User in einer Liste User
	 * können Teilnehmer, als auch Organisator sein.
	 * 
	 * @param user
	 *            Teilnehmer oder Organisator eines Events
	 ...
	 * 
	 * @param startDate
	 *            Startzeitpunkt des Zeitraums in der die Belegung stattfindet
	 * @param endDate
	 *            Endzeitpunkt des Zeitraums
	 ...
	 * User sind nur Teilnehmer, mit Teilnehmer sind alle Eingeladenen gemeint,
	 * unabhängig vom participationstatus
	 * 
	 * @param user
	...
	/**
	 * Ausgeben aller Invitation-Objekte zu einem Event wird z.B. bei der
	 * Delete-Methode von Events benötigt
	 * 
	 * @param event
	 *            Event-Objekt
	...
	/**
	 * Ausgeben aller Invitation-Objekte zu einem User wird z.B. bei der
	 * Delete-Methode von Usern benötigt
	 * 
	 * @param user
	 *            User-Objekt
	 * @return Vector Objekt mit Invitations, welche die Suchkriterien erfüllen
